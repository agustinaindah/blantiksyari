...
public class ItemDataHewan implements Serializable {
    ...
    @SerializedName("data_hewan")
    @Expose
    private String dataHewan;
    ...
    @Expose
    private Object pinBbUser;
    @SerializedName("data_hewan_array")
    @Expose
    private String dataHewanArray;
    @SerializedName("data_hewan_text")
    @Expose
    private String dataHewanText;
    @SerializedName("images_2")
    @Expose
    private List<Images2> images2 = new ArrayList<Images2>();
    ...
    public String getDataHewan() {
        return dataHewan;
    }

    public void setDataHewan(String dataHewan) {
    ...
    public Object getPinBbUser() {
        return pinBbUser;
    }

    public void setPinBbUser(Object pinBbUser) {
        this.pinBbUser = pinBbUser;
    }

    public String getDataHewanArray() {
        return dataHewanArray;
    }

    public void setDataHewanArray(String dataHewanArray) {
        this.dataHewanArray = dataHewanArray;
    }

    public String getDataHewanText() {
        return dataHewanText;
    }

    public void setDataHewanText(String dataHewanText) {
        this.dataHewanText = dataHewanText;
    }

    public List<Images2> getImages2() {
        return images2;
    }

    public void setImages2(List<Images2> images2) {
